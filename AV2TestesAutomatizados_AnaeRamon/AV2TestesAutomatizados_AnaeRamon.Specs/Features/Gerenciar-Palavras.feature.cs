...
namespace AV2TestesAutomatizados_AnaeRamon.Specs.Features
{
    ...
    public partial class GerenciarPalavrasCadastradasFeature
    {
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Exibição de Palavra-Chave")]
        public virtual void ExibicaoDePalavra_Chave()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Exibição de Palavra-Chave", ((string[])(null)));
            this.ScenarioSetup(scenarioInfo);
            testRunner.Given("que estou no menu principal do app BotTweeter", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Dado ");
